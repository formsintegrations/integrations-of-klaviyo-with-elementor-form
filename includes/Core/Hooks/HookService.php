...
namespace FormInteg\IKLAVIYOEF\Core\Hooks;

use FormInteg\IKLAVIYOEF\Core\Util\Request;
use FormInteg\IKLAVIYOEF\Admin\AdminAjax;
...
class HookService
{
    ...
    {
        if (Request::Check('ajax') && is_readable(IKLAVIYOEF_PLUGIN_BASEDIR . 'includes' . DIRECTORY_SEPARATOR . 'Routes' . DIRECTORY_SEPARATOR . 'ajax.php')) {
            include IKLAVIYOEF_PLUGIN_BASEDIR . 'includes' . DIRECTORY_SEPARATOR . 'Routes' . DIRECTORY_SEPARATOR . 'ajax.php';
        }
        if (is_readable(IKLAVIYOEF_PLUGIN_BASEDIR . 'includes' . DIRECTORY_SEPARATOR . 'hooks.php')) {
            include IKLAVIYOEF_PLUGIN_BASEDIR . 'includes' . DIRECTORY_SEPARATOR . 'hooks.php';
        }
    }
    ...
    {
        $task_dir = IKLAVIYOEF_PLUGIN_BASEDIR . 'includes' . DIRECTORY_SEPARATOR . $task_name;
    ...
    {
        if (is_readable(IKLAVIYOEF_PLUGIN_BASEDIR . 'includes' . DIRECTORY_SEPARATOR . 'Routes' . DIRECTORY_SEPARATOR . 'api.php')) {
            include IKLAVIYOEF_PLUGIN_BASEDIR . 'includes' . DIRECTORY_SEPARATOR . 'Routes' . DIRECTORY_SEPARATOR . 'api.php';
        }
    }
}
