  ...
  return (
    <div className="flx pos-rel btcd-logic-blk">
      ...
      >
        ...
        <option value="not_equal">{__('Not Equal')}</option>
        <option value="null">{__('Is Null')}</option>
        <option value="not_null">{__('Is Not Null')}</option>
        ...
        <option value="not_contain">{__('Not Contain')}</option>
        <option value="greater">{__('Greater Than (Number)')}</option>
        <option value="less">{__('Less Than (Number)')}</option>
        <option value="greater_or_equal">{__('Greater Than or Equal (Number)')}</option>
        <option value="less_or_equal">{__('Less Than or Equal (Number)')}</option>
        <option value="start_with">{__('Start With')}</option>
        <option value="end_with">{__('End With')}</option>
      </MtSelect>
